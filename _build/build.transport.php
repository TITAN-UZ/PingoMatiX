 ...
 */
/**
 * Build PingoMatiX Package
 *
 * Description: Build script for PingoMatiX package
 * @package pingomatix
 * @subpackage build
 */

/* See the pingomatix/core/docs/tutorial.html file for
 ...
 *
 * PingoMatiX -> Name of your package
 * pingomatix -> lowercase name of your package
 * Peter Edley -> Your Actual Name
 * Peter Edley -> Name of your site
 * yoursite -> domain name of your site
 * peter@cww.org.uk -> your email address
 * Description -> Description of file or component
 *
 * 22/8/11 -> Current date
 * 2011 -> Current Year
 */

/* Set package info be sure to set all of these */
define('PKG_NAME','PingoMatiX');
define('PKG_NAME_LOWER','pingomatix');
define('PKG_VERSION','1.0.0');
define('PKG_RELEASE','beta1');
define('PKG_CATEGORY','PingoMatiX');
...
$sources= array (
    ...
    'docs' => $root . 'core/components/pingomatix/docs/',
...
/* This section transfers every file in the local
 pingomatixs/pingomatix/assets directory to the
 target site's assets/pingomatix directory on install.
...
/* This section transfers every file in the local 
 pingomatixs/pingomatix/core directory to the
 target site's core/pingomatix directory on install.
